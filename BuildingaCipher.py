...
# Step 68
# Call your function passing text and custom_key 
# as the arguments. Store the return value of the 
# function call in a variable called encryption.
...
# Step 69 Passed
# And now, try to print encryption to see 
# the actual output on the terminal.
...
# Also, comment out the last two lines of code to avoid errors in the console.
...
# Step 71 Passed
# All you need to do is multiply the offset by the direction in the 
# new_index assignment. The multiplication operator in Python is *.
...
# Step 71
# Now you can uncomment the last two lines and 
...
# Declare another variable called decryption and assign it 
# vigenere(encryption, custom_key, -1)
...
# Step 76 Passed
# Update your comments too. 
# Your second comment should say encode/decode in place of encode. 
# Your third comment should say encrypted/decrypted in place of encrypted.
...
# For example, the function below accepts three arguments but you can call it passing two arguments. 
